...
**Phase**: Implementation — Step 3 in progress
...
| 3 | TDD — `utils/helpers.py` + `app/chat.py` + all unit and integration tests | `in progress` |
| 4 | `01_ollama_setup.ipynb` — Ollama API, model management, streaming | `pending` |
